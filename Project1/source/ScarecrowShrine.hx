...
class ScarecrowShrine extends Shrine
{
	...
	override private function create():Void{
		...
		ticker = new TickingText(false, "Earthshrine_interact_1.txt", .04, 12, "Water_Text", 100, Std.int(y) - 100);
		ticker2 = new TickingText(false, "Earthshrine_text_2.txt", .04, 12, "Water_Text", 100, Std.int(y) - 100);
		ticker3 = new TickingText(false, "Earthshrine_after_song_3.txt", .04, 12, "Water_Text", 100, Std.int(y) - 100);
	}
